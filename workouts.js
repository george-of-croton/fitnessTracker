...
function listWorkouts (workouts) {
 workouts.forEach(function (workouts) { console.log(workouts) })
}
...
function addNewWorkout (details) {
  ...
  return knex('workouts')
          .insert({'activity': details[0],'duration': details[1],'distance': details[2], 'location': details[3], "route": details[4]})
}
